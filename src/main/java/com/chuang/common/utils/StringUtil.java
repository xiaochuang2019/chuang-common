	...
	// 方法1：判断源字符串是否有值，空引号(空白字符串)也算没值 (5分)
		...
		public static String randomChineseString(int length) {
			...
			for (int i = 0; i < length; i++) {
				string.append(randomChineseString());
			}
		...
		public static String generateChineseName() {
			...
			String firstNameString=firstName[RandomUtil.random(0, firstName.length-1)];
			String chineseString = randomChineseString(RandomUtil.random(1,2));
